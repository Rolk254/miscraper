...
Copiar
npm install
Configura la base de datos. Asegúrate de tener una base de datos MySQL configurada con las tablas adecuadas para usuarios y productos.
...
Seguridad
La API utiliza JSON Web Tokens (JWT) para la autenticación de usuarios. Al hacer login, se genera un token que debe ser enviado en las cabeceras de las solicitudes autenticadas. Ejemplo de cabecera de autorización:
